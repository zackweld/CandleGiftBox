...
import { LocalLoggerMethods, LogMethods } from '../types/logger.js';
...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.logMessage = function (severity, message, options) {
        ...
        if (isDefined(this.localLogger)) {
            ...
            (_b = (_a = this.localLogger)[LocalLoggerMethods[severity]]) === null || _b === void 0 ? void 0 : _b.call(_a, message, __assign({}, (logOptions === null || logOptions === void 0 ? void 0 : logOptions.error) && { error: logOptions.error }));
        }
        else {
