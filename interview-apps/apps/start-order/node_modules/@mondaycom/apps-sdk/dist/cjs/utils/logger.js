...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.logMessage = function (severity, message, options) {
        ...
        if ((0, guards_1.isDefined)(this.localLogger)) {
            ...
            (_b = (_a = this.localLogger)[logger_1.LocalLoggerMethods[severity]]) === null || _b === void 0 ? void 0 : _b.call(_a, message, __assign({}, (logOptions === null || logOptions === void 0 ? void 0 : logOptions.error) && { error: logOptions.error }));
        }
        else {
